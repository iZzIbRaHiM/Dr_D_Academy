      ...
      <section className="py-12">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="glass-dark rounded-2xl p-8 md:p-12 gold-border-glow cursor-pointer group"
          >
            <span className="px-3 py-1 text-xs font-sans font-semibold tracking-wider uppercase bg-primary/10 text-primary rounded-full border border-primary/30">
            ...
            <p className="text-muted-foreground font-sans leading-relaxed max-w-3xl mb-6">
              {blogPosts[0].excerpt}
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.slice(1).map((post, i) => (
              <motion.div
                ...
                className="glass-dark rounded-xl p-6 gold-border-glow cursor-pointer group flex flex-col"
              >
                ...
                <h3 className="font-serif text-xl font-bold text-foreground mt-4 mb-3 group-hover:text-primary transition-colors">
                  {post.title}
                </h3>
